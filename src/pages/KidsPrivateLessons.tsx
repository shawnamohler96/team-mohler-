...
import { Shield, Users, Trophy, Star, Clock, Target, Zap, Heart, Smile, Award } from 'lucide-react';
import { Link } from 'react-router-dom';
import SEO from '../components/SEO';
import CTASection from '../components/CTASection';

export default function KidsPrivateLessons() {
  const benefits = [
    {
      title: "Focused Skill Building",
      icon: <Target size={40} />,
      description: "One-on-one attention helps children master complex movements and techniques at their own pace."
    },
    {
      title: "Confidence Boost",
      icon: <Smile size={40} />,
      description: "Personalized coaching provides a safe space for children to overcome challenges and build self-esteem."
    },
    {
      title: "Competition Prep",
      icon: <Trophy size={40} />,
      description: "Specific training for young athletes looking to excel in tournaments and high-level competition."
    },
    {
      title: "Character Development",
      icon: <Award size={40} />,
      description: "Focused mentorship that reinforces discipline, respect, and focus beyond the standard class setting."
    }
  ];
  ...
  return (
    <div className="bg-white pt-32">
      <SEO 
        title="Kids Private Martial Arts Lessons Grapevine" 
        description="Private martial arts lessons for kids in Grapevine. One-on-one BJJ, boxing, and MMA training that builds confidence, focus, and discipline." 
      />
      ...
      <section className="relative min-h-[85vh] flex flex-col lg:flex-row bg-white overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-white z-10">
          <motion.div
            ...
            className="max-w-xl"
          >
            <span className="text-micro text-white mb-8 block uppercase font-bold tracking-[0.5em] bg-accent-red px-4 py-1 inline-block">Youth Excellence</span>
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display text-ink leading-[0.8] mb-12 uppercase tracking-tighter">
              KIDS PRIVATE <span className="text-accent-red italic">LESSONS</span>
            </h1>
            <p className="text-xl md:text-2xl text-ink font-light mb-16 leading-tight uppercase tracking-widest border-l-2 border-accent-red pl-8">
              Empowering the next generation through personalized, world-class mentorship and technical training.
            </p>
        ...
        <div className="w-full lg:w-1/2 relative min-h-[50vh] lg:min-h-full">
          <motion.img 
            ...
            src={`${import.meta.env.BASE_URL}KidsPrivateLesson.jpeg`} 
      ...
      {/* Main Content: Why Kids Private Lessons? */}
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto">
            <span className="text-micro text-accent-red mb-6 block uppercase font-bold tracking-[0.4em]">Why Choose Youth Private Training?</span>
            <h2 className="text-5xl md:text-7xl font-display text-ink leading-[0.85] uppercase mb-12 tracking-tighter">
              FOCUSED ON THEIR <span className="text-accent-red">FUTURE</span>
            </h2>
            <div className="space-y-8">
              <p className="text-xl text-ink/80 leading-relaxed font-light">
                Every child learns differently. Private lessons allow our expert instructors to adapt their teaching style to match your child's unique personality and learning pace, ensuring they get the most out of every minute on the mat.
              </p>
              <p className="text-xl text-ink/80 leading-relaxed font-light">
                Whether your child is looking to overcome a technical plateau, prepare for their first tournament, or simply needs a more focused environment to build their confidence, our youth private lessons provide the perfect platform for rapid growth.
              </p>
            </div>
          </div>
      ...
      <CTASection image={`${import.meta.env.BASE_URL}KidsPrivateLesson.jpeg`} />
    </div>
  );
}
