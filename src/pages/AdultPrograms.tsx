...
const programs = [
  {
    ...
    path: "/bjj",
    img: `${import.meta.env.BASE_URL}IMG_1490_1_2.jpeg`
  },
  {
    id: "02",
    title: "Boxing",
    ...
    path: "/boxing",
    img: `${import.meta.env.BASE_URL}lady_boxing.jpeg`
  },
  {
    id: "03",
    ...
    img: `${import.meta.env.BASE_URL}Kickboxing_Image.jpeg`
  },
  {
    id: "04",
    title: "MMA",
    ...
    path: "/mma",
    img: `${import.meta.env.BASE_URL}Wrestling_class.jpeg`
  },
  {
    id: "05",
    title: "Wrestling",
    ...
    path: "/wrestling",
    img: `${import.meta.env.BASE_URL}2_guys_grappling_close_up_2.jpeg`,
    scale: "scale-125"
  }
];
      ...
      <section className="relative min-h-[85vh] flex flex-col lg:flex-row bg-white overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 relative min-h-[50vh] lg:min-h-full">
          <motion.img 
            ...
            src={`${import.meta.env.BASE_URL}gym_tour_pic_1.jpeg`} 
