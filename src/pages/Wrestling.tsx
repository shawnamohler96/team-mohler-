...
export default function Wrestling() {
  const pillars = [
    {
      title: "Develop Explosive Power",
      icon: <Trophy size={40} />,
      description: "Build functional strength and power through intense wrestling drills and exercises that engage your entire body."
    },
    {
      title: "Master Fundamental Techniques",
      icon: <Users size={40} />,
      description: "Learn essential takedowns, escapes, and grappling techniques from experienced wrestling coaches."
    },
    {
      title: "Enhance Your Athleticism",
      icon: <Star size={40} />,
      description: "Improve your agility, coordination, and balance as you master the dynamic movements of wrestling."
    },
    {
      title: "Build Mental Toughness",
      icon: <Shield size={40} />,
      description: "Wrestling challenges you both physically and mentally, helping you develop discipline, resilience, and a never-give-up attitude."
    }
  ];
  ...
  return (
    <div className="bg-white pt-32">
      <SEO 
        title="Adults Wrestling | Team Mohler MMA" 
        description="Improve your grappling with adult wrestling classes at Mohler MMA in Grapevine, TX. Our program focuses on takedowns, control, and athleticism. Start your free trial today!" 
      />
      ...
      <section className="relative min-h-[85vh] flex flex-col lg:flex-row bg-white overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-white z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display text-ink leading-[0.8] mb-12 uppercase tracking-tighter">
              WRESTLING <br />
              <span className="text-accent-red italic text-4xl md:text-6xl lg:text-8xl block mt-2">& TAKEDOWNS</span>
            </h1>
            <p className="text-xl md:text-2xl text-ink font-light mb-16 leading-tight uppercase tracking-widest border-l-2 border-accent-red pl-8">
              The Foundation of Every Great Martial Artist.
            </p>
        ...
        <div className="w-full lg:w-1/2 relative min-h-[50vh] lg:min-h-full">
          <motion.img 
            ...
            src={`${import.meta.env.BASE_URL}Wrestling_class.jpeg`} 
            alt="Adult Wrestling" 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-5xl md:text-7xl font-display text-ink leading-[0.85] uppercase mb-12 tracking-tighter">
              THE BRIDGE TO <span className="text-accent-red italic">DOMINANCE</span>
            </h2>
            <div className="space-y-8">
              <p className="text-xl text-ink/80 leading-relaxed font-light">
                Our wrestling classes are carefully designed to elevate your overall MMA and Jiu-Jitsu game.
              </p>
              <p className="text-xl text-ink/80 leading-relaxed font-light">
                By mastering takedowns, clinches, and positional control, you’ll gain the ability to dictate the pace of any fight or match. Wrestling teaches you how to control your opponent, stay dominant on the mat, and create openings for strikes or submissions—giving you a complete skill set to succeed both in training and in real-world self-defense situations.
              </p>
            </div>
      ...
      <CTASection image={`${import.meta.env.BASE_URL}Wrestling_class.jpeg`} />
    </div>
  );
}
