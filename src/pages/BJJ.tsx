...
export default function BJJ() {
  const pillars = [
    {
      ...
      icon: <Star size={40} />,
      description: "Learn from experienced black belts dedicated to helping you reach your full potential."
    },
    {
      title: "Structured Curriculum",
      icon: <Trophy size={40} />,
      description: "Our BJJ program covers everything from fundamental techniques to advanced concepts."
    },
    {
      title: "Supportive Community",
      icon: <Users size={40} />,
      description: "Train in a positive and encouraging environment with like-minded individuals."
    },
    {
      title: "Real-World Self-Defense",
      icon: <Shield size={40} />,
      description: "Develop practical self-defense skills that can help you stay safe in any situation."
    }
  ];
  ...
  return (
    <div className="bg-white pt-32">
      <SEO 
        title="Adults Brazilian Jiu Jitsu | Team Mohler MMA" 
        description="Learn Brazilian Jiu-Jitsu in Grapevine, TX at Mohler MMA. Our adult BJJ classes offer world-class instruction in a supportive environment. Start your free trial today!" 
      />
      ...
      <section className="relative min-h-[85vh] flex flex-col lg:flex-row bg-white overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-white z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display text-ink leading-[0.8] mb-12 uppercase tracking-tighter">
              BRAZILIAN <span className="text-accent-red italic">JIU-JITSU</span>
            </h1>
            <p className="text-xl md:text-2xl text-ink font-light mb-16 leading-tight uppercase tracking-widest border-l-2 border-accent-red pl-8">
              Perfect for those looking to build real-world self-defense and functional fitness. No experience? No problem—our beginner classes are designed for you
            </p>
        ...
        <div className="w-full lg:w-1/2 relative min-h-[50vh] lg:min-h-full">
          <motion.img 
            ...
            src={`${import.meta.env.BASE_URL}2_BJJ_students_grappling_comp_2.jpeg`} 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-ink/80 leading-relaxed font-light">
                Brazilian Jiu Jitsu is practiced in sport grappling tournaments and MMA competitions, as well as for self-defense. Typically, a Jiu-Jitsu practitioner wears a GI. Students can choose to grapple with or without a GI.
              </p>
            </div>
