...
export default function SocialSection() {
  const fallbackImages = [
    { src: '/gym-tour-pic-6.jpeg', alt: 'Training 1' },
    { src: '/gym-tour-pic-7.jpeg', alt: 'Training 2' },
    { src: '/gym-tour-pic-3.jpg', alt: 'Training 3' },
    { src: '/gym-tour-pic-4.jpg', alt: 'Training 4' },
    { src: '/mohlerteaching-bjj.jpeg', alt: 'Training 5' },
    { src: '/grappling-closeup.jpeg', alt: 'Training 6' },
  ];
